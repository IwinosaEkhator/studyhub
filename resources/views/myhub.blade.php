...
<body>
    ...
    <section id="experience">
        <div class="row">
            <div class="col-6">
                ...
                <h1 class="mt-1 mb-4"><span style="font-size: 38px; font-weight: 400;">We Provide You The</span><br>
                    Experience</h1>
    ...
    <section id="popular">
        <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
            ...
            <a class="mt-4 pe-4 text-decoration-none" style="font-size: 18px; font-weight: 600; color: #9eb8d9">View All
        ...
        <div class="slide-container">
            <div class="prod-wrapper">
                <div class="prod">
                    <span class="text-end d-flex justify-content-end pe-1 price-off"><a href=""><i
                                class="fa-regular fa-heart fa-lg text-white"></i></a>
                        <a href=""><i class="fa-regular fa-bookmark ms-3 fa-lg text-white"></i></a>
                    </span>
                    <div class="image-box">
                ...
                <div class="prod">
                    ...
                    <div class="prod-info">
                        ...
                        <span class="d-flex justify-content-between mt-3 prod-icons"><a href="#">
                                <i class="fa-regular fa-heart fa-lg"></i>
                            </a>
                            <a href="#"><i class="fa-regular fa-bookmark ms-3 fa-lg"></i></a></span>
                    </div>
                </div>
    ...
    <section id="popular">
        <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
            <h1>Favourites</h1>
            <a class="mt-4 pe-4 text-decoration-none" style="font-size: 18px; font-weight: 600; color: #9eb8d9">View
