<!DOCTYPE html>
<html lang="en">
@include("admin.include.adminhead")
  <body>
            ...
            <form action="" method="post">
              <div class="formbold-input-flex">
                <div>
                  ...
                  />
                  <label for="bookname" class="formbold-form-label">
                    Book name
                  </label>
                </div>
                <div>
                  ...
                  <label class="formbold-form-label" for="category">Category</label>
                </div>
              </div>
              ...
              <div class="formbold-input-file">
                ...
                <label for="upload_cover" class="formbold-input-label">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                  ...
                  Attach book cover
                  <input type="file" name="upload_cover" id="upload" />
                </label>
              </div>
